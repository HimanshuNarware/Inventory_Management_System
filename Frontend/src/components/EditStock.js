...
export default function EditStock({ product, onClose, onStockUpdated }) {
  ...
  const updateStock = () => {
    ...
    const updatedProduct = {
      productID: product._id, // Add the productID field expected by the backend
      name: product.name,
    ...
    fetch(`${process.env.REACT_APP_BACKEND_URL}api/product/update`, {
      ...
      .then((result) => {
        ...
        notificationContext.addStockUpdateNotification(product.name, stock);
