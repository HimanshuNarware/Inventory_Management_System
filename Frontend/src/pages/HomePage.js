  ...
  return (
    <div className="bg-white">
      ...
      <div className="py-12 bg-white" id="about-us">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            <h2 className="text-base text-bg-600  font-bold tracking-wide  ">
            About us
            </h2>
            ...
            Our platform offers an easy and affordable solution for businesses of all sizes to manage their inventory
            </p>
          </div>
      ...
      <div className="py-12 bg-white" id="services">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            <h2 className="text-base text-stone-800 font-bold  tracking-wide uppercase">
              Service's
            </h2>
            <p className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
            ...
            Our platform makes inventory management simple with a variety of helpful services – all in one easy-to-use system.
            </p>
          </div>
      ...
      <footer className="bg-gray-800">
        <div className="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
          ...
          <p className="mt-8 text-center text-base text-gray-400">
            &copy; 2023 Inventory Management System. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
